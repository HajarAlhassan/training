    ...
    render() {
        return (
            < div className=" text-center ">
                ...
                <div className="brand">
                   <img src="https://www.vhv.rs/dpng/d/593-5939450_library-icon-library-icon-transparent-background-hd-png.png" style = {{borderRadius:"50%",height: 100, width: 150, resizeMode : 'stretch',float:'left'}} />
